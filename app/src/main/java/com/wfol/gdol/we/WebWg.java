...
public class WebWg extends WebView {

    public WebWg(@NonNull Context context) {
        super(context);
    }
    public WebWg(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context){
        ...
        this.setWebViewClient(new kid());
        this.setWebChromeClient(new Yiud());
